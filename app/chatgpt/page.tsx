...
export default function EmergencyChatGPTPage() {
  ...
  const sendInitialEmergencyMessage = async () => {
    ...
    try {
      ...
      if (response.ok) {
        ...
        toast.success('Emergency ChatGPT activated!', {
          ...
          <div className="flex items-center gap-3 mb-3">
            ...
            <div className="flex-1">
              <div className="flex items-center gap-2">
                ...
                <h1 className="text-lg font-bold text-gray-900">Emergency ChatGPT</h1>
              </div>
